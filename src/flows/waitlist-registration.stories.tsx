...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: `**\`references/flows/5-WaitlistRegistration\`** — not yet built.
    ...
    render: () => (
        <KioskScreen scroll={false} footer={<GlobalNav />}>
            <div className="flex h-full flex-col items-center justify-center gap-3 px-16 text-center">
                <p className="text-[28px] font-bold text-primary">Waitlist Reg</p>
                <p className="text-[18px] text-tertiary">references/flows/5-WaitlistRegistration</p>
            </div>
        </KioskScreen>
    ),
};
